...
/**
 * Perform action on list of String
 * 1 = check if the string is palindrome, if not throw exception
 * 2 = check if first half of the string is equal to 2nd half of the string , if not throw exception
 *
 */
